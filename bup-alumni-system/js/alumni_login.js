/**
 * BUP Alumni System - Alumni Login JavaScript
 */
...
async function loginAlumni(formData) {
    console.log('🌐 Making API call to:', `${API_BASE_URL}/alumni/login`);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('✅ Alumni login page loaded successfully');
